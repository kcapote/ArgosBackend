...
router.get(
  ...
  [authentication.verifyToken, authentication.refreshToken],
  (req, res, next) => {
    let pagination = req.query.pagination || 0;
    pagination = Number(pagination);
    ...
    EmployeeSubTask.find({ recordActive: recordActive })
      ...
      .exec((err, employeeSubTasks) => {
        if (err) {
          ...
          EmployeeSubTask.find({ recordActive: recordActive }).count(
            {},
            (err, totalRecords) => {
              res.status(200).write(
                JSON.stringify(
...
router.get(
  "/employee/calendar/:idEmployee/:initDate/:endDate",
  [authentication.verifyToken, authentication.refreshToken],
  (req, res, next) => {
    let idEmployee = req.params.idEmployee;
...
router.get(
  "/employee/calendar/project/:idProject/:idEmployee/:initDate/:endDate",
  [authentication.verifyToken, authentication.refreshToken],
  (req, res, next) => {
    let idProject = req.params.idProject;
    let idEmployee = req.params.idEmployee;
...
router.get(
  "/employee/calendar/project/:idProject/:initDate/:endDate",
  [authentication.verifyToken, authentication.refreshToken],
  (req, res, next) => {
    let idProject = req.params.idProject;
    let initDate = `${req.params.initDate} 00:00:00.000Z`;
...
router.get(
  "/employee/:idProject/:idFloor/:idDepartment/:idEmployee",
  [authentication.verifyToken, authentication.refreshToken],
  (req, res, next) => {
    let idProject = req.params.idProject;
    let idEmployee = req.params.idEmployee;
...
router.get(
  "/employee/:idProject/:idCommonService/:idEmployee",
  [authentication.verifyToken, authentication.refreshToken],
  (req, res, next) => {
    let idProject = req.params.idProject;
    let idEmployee = req.params.idEmployee;
...
router.get(
  "/department/:idProject/:idFloor/:idDepartment",
  [authentication.verifyToken, authentication.refreshToken],
  (req, res, next) => {
    let idProject = req.params.idProject;
    let idDepartment = req.params.idDepartment;
...
router.get(
  "/department/:idProject/:idFloor/:idDepartment/:idTask/:idSubTask",
  [authentication.verifyToken, authentication.refreshToken],
  (req, res, next) => {
    let idProject = req.params.idProject;
    let idDepartment = req.params.idDepartment;
...
router.get(
  "/commonService/:idProject/:idCommonService",
  [authentication.verifyToken, authentication.refreshToken],
  (req, res, next) => {
    let idProject = req.params.idProject;
    let idCommonService = req.params.idCommonService;
...
router.get(
  "/commonService/:idProject/:idCommonService/:idTask",
  [authentication.verifyToken, authentication.refreshToken],
  (req, res, next) => {
    let idProject = req.params.idProject;
    let idCommonService = req.params.idCommonService;
...
router.get(
  "/commonService/:idProject/:idCommonService/:idTask/:idSubTask",
  [authentication.verifyToken, authentication.refreshToken],
  (req, res, next) => {
    let idProject = req.params.idProject;
    let idCommonService = req.params.idCommonService;
...
router.post(
  ...
  (req, res, next) => {
    ...
    EmployeeSubTask.findOne({
      project: req.body.project,
      employee: req.body.employee,
      $and: [
        { recordDate: { $gte: dateRecord } },
        { recordDate: { $lte: dateRecord } }
      ]
    })
      .populate("employee")
      .exec((err, employee) => {
        ...
        if (employee) {
          return res.status(400).json({
            success: false,
            message:
              "El empleado ya posee registros para la fecha " +
              req.body.recordDate,
            errors: {
              message:
                "El empleado " +
                employee.employee.rut +
                ": " +
                employee.employee.name +
                " ya posee registros para la fecha " +
                req.body.recordDate
            },
            user: req.user,
            employee: employee
    ...
    EmployeeSubTask.findById(id, (err, employeeSubTask) => {
      ...
      if (!employeeSubTask) {
        return res.status(400).json({
          ...
          errors: {
            message: "No se pudo encontrar el registro para actualizar"
          },
          user: req.user
        });
      } else {
            ...
            if (d) {
              ...
              for (let o of d) {
                ...
                let temp = {
                  id: o._id,
                  total: o.total,
                  proName: projects.find(function(obj) {
