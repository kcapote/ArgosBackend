...
router.get('/task/:idProject/:idTask/:type', authentication.verifyToken, (req, res, next) => {
    ...
    CommonServiceTask.find({ 'project': idProject, 'task': idTask, 'type': type })
        .populate('commonService')
        .populate('task')
        .populate('project')
        .exec(
...
router.get('/task/:idProject/:idTask', authentication.verifyToken, (req, res, next) => {
    ...
    CommonServiceTask.find({ 'project': idProject, 'task': idTask })
        .populate('commonService')
        .populate('task')
        .populate('project')
        .exec(
...
router.get('/commonservice/:idProject/:idcommonService', authentication.verifyToken, (req, res, next) => {
    ...
    CommonServiceTask.find({ 'project': idProject, 'commonService': idcommonService })
        .populate('commonService')
        .populate('task')
        .populate('project')
        .exec(
...
router.get('/project/:idProject', authentication.verifyToken, (req, res, next) => {
    ...
    CommonServiceTask.find({ 'project': idProject })
        .populate('commonService')
        .populate('task')
        .populate('project')
        .exec(
...
router.get('/project/:idProject/:type', authentication.verifyToken, (req, res, next) => {
    ...
    CommonServiceTask.find({ 'project': idProject, 'type': type })
        .populate('commonService')
        .populate('task')
        .populate('project')
        .exec(
...
router.delete('/:id', authentication.verifyToken, (req, res, next) => {
    ...
    CommonServiceTask.findByIdAndRemove(id, (err, commonServiceTask) => {
        if (err) {
            return res.status(500).json({
                success: false,
